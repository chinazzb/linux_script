...
def enable_tomcat():
    os.system("cp /usr/local/tomcat/bin/catalina.sh /etc/init.d/tomcat && chmod 755 /etc/init.d/tomcat")
...
def system_firewalld():
    replace('/etc/sysconfig/SuSEfirewall2','FW_SERVICES_EXT_TCP=""','FW_SERVICES_EXT_TCP="8080"')
